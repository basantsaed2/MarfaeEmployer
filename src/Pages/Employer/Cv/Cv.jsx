...
const Cv = () => {
    ...
    // Extract unique jobs for filtering - using object instead of Map
    useEffect(() => {
                            ...
                            >
                                <div className="w-full p-4">
                                    <div className="w-full flex justify-between items-start mb-4">
                                        ...
                                        <span
                                            className={`px-2 py-1 rounded-full text-xs font-medium border flex items-center flex-shrink-0 ml-2 ${getStatusClass(app.status)}`}
                                        >
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusClass(selectedApplication.status)}`}>

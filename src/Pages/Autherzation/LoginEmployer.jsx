...
//           </div>
//           <div className="p-6">
//             <h2 className="text-3xl text-bg-primary underline font-bold text-center mb-3">Log in</h2>
//             <p className="text-center text-blue-600 mb-6">
//               <Link className="underline font-semibold" to="/register">Register a new account</Link>
//             </p>
...
const LoginEmployer = () => {
  ...
  const handleModalClose = () => {
    ...
    // Optionally redirect to a specific page, e.g., home or account activation page
